...
# plot
nCount_RNA_violin <- VlnPlot(obj, features = "nCount_RNA", layer="counts", group.by="orig.ident",raster=FALSE,alpha=0) +
...
```{r eval=FALSE}
saveRDS(nCount_RNA_violin, file = "../plots/rds/nCount_RNA_violin.rds")
ggsave("../plots/single_plots/nCount_RNA_violin.png",height=5,width=7,dpi=300,units="in")
```
...
```{r}
nCount_RNA_density <- ggplot(metadata, aes(color=orig.ident, x=nCount_RNA, fill= orig.ident)) + 
...
```{r eval=FALSE}
saveRDS(nCount_RNA_density, file = "../plots/rds/nCount_RNA_density.rds")
ggsave("../plots/single_plots/nCount_RNA_density.png",height=5,width=7,dpi=300,units="in")
```
...
```{r}
nFeature_RNA_violin <- VlnPlot(obj, features = "nFeature_RNA",
                               group.by="orig.ident",
                               alpha = 0) +
  scale_fill_manual(values=cnames) + 
  theme(axis.title.x = element_blank())
...
nFeature_RNA_density <- ggplot(metadata, aes(color=orig.ident, x=nFeature_RNA, fill= orig.ident)) +
  geom_density(alpha = 0.2) + 
  theme_classic() +
  scale_x_log10() + 
  geom_vline(xintercept = 200,color="red",linetype="dotted")
nFeature_RNA_density
```
```{r eval=FALSE}
saveRDS(nFeature_RNA_violin, file = "../plots/rds/nFeature_RNA_violin.rds")
ggsave("../plots/single_plots/nFeature_RNA_violin.png",plot = nFeature_RNA_violin, height=5,width=7,dpi=300,units="in")

saveRDS(nFeature_RNA_density, file = "../plots/rds/nFeature_RNA_density.rds")
ggsave("../plots/single_plots/nFeature_RNA_density.png",plot = nFeature_RNA_density, height=5,width=7,dpi=300,units="in")
...
```{r}
percent.mt_violin <- VlnPlot(obj, features = "percent.mt", group.by="orig.ident",
        alpha = 0.1) +
  scale_fill_manual(values=cnames) +
...
percent.mt_density <- ggplot(metadata, aes(color=orig.ident, x=percent.mt, fill= orig.ident)) +
  geom_density(alpha = 0.2) + 
  scale_x_log10() +
  theme_classic() +
...
```{r eval=FALSE}
saveRDS(percent.mt_violin, file = "../plots/rds/percent.mt_violin.rds")
ggsave("../plots/single_plots/percent.mt_violin.png",plot = percent.mt_violin, height=5,width=7,dpi=300,units="in")

saveRDS(percent.mt_density, file = "../plots/rds/percent.mt_density.rds")
ggsave("../plots/single_plots/percent.mt_density.png",plot = percent.mt_density, height=5,width=7,dpi=300,units="in")
...
```{r}
nFeature_RNA_by_percent.mt_fs <- FeatureScatter(obj, feature1 = "percent.mt", feature2 ="nFeature_RNA", group.by="orig.ident", split.by="condition") 
nFeature_RNA_by_percent.mt_fs

nFeature_RNA_by_nCount_RNA_fs <- FeatureScatter(obj, feature1 = "nCount_RNA", feature2 = "nFeature_RNA", group.by="orig.ident", split.by="condition", log=TRUE)
nFeature_RNA_by_nCount_RNA_fs


```
```{r eval=FALSE}
saveRDS(nFeature_RNA_by_percent.mt_fs, file = "../plots/rds/nFeature_RNA_by_percent.mt_fs.rds")
ggsave("../plots/single_plots/nFeature_RNA_by_percent.mt_fs.png",plot = nFeature_RNA_by_percent.mt_fs, height=5,width=7,dpi=300,units="in")

saveRDS(nFeature_RNA_by_nCount_RNA_fs, file = "../plots/rds/nFeature_RNA_by_nCount_RNA_fs.rds")
ggsave("../plots/single_plots/nFeature_RNA_by_nCount_RNA_fs.png",plot = nFeature_RNA_by_nCount_RNA_fs, height=5,width=7,dpi=300,units="in")
...
filt_cell_counts_per_sample_barplot <- obj_filt@meta.data %>% 
...
filt_cell_counts_per_sample_barplot
```
```{r eval=FALSE}
saveRDS(filt_cell_counts_per_sample_barplot, file = "../plots/rds/filt_cell_counts_per_sample_barplot.rds")
ggsave("../plots/single_plots/filt_cell_counts_per_sample_barplot.png",height=5,width=7,dpi=300,units="in")
```
...
obj_filt <- FindNeighbors(obj_filt, dims = 1:30)
...
DimPlot(obj_filt, 
        reduction = "umap", 
        group.by = c("orig.ident", "seurat_clusters","condition","patient_id"),
        alpha=0.4, ncol=2)
```
...
#| fig-width: 4
#| fig-height: 6
umap_patient_tissue_type <- DimPlot(obj_filt, 
        reduction = "umap", 
        group.by = c("condition","patient_id"),
        alpha=0.4, ncol=1)
umap_patient_tissue_type
```
```{r eval=FALSE}
saveRDS(umap_patient_tissue_type, file = "../plots/rds/umap_patient_tissue_type.rds")
ggsave("../plots/single_plots/umap_patient_tissue_type.png",height=6,width=4,dpi=300,units="in")
```
